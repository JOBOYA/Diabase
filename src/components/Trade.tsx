...
export const Trade = () => {
    ...
    return (
        <div id="trade" className="trade flex flex-col items-center">
            <h2 className="text-3xl md:text-6xl text-center font-bold mt-10 md:mt-20 md:m-20 text-slate-800">Trade</h2>
